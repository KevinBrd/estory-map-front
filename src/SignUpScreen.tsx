        ...
        <div className="min-h-screen bg-purple-400 flex justify-center items-center">
            ...
            <div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
                ...
                <div className="text-center mt-6">
                    <button onClick={signup} className="py-3 w-64 text-xl text-white bg-purple-400 rounded-2xl">Create Account</button>
                    <p className="mt-4 text-sm">Already Have An Account? <button onClick={() => setShowLoginScreen(true)} className="underline cursor-pointer">Sign In</button>
                    </p>
                </div>
            </div>
