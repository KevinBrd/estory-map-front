...
import { useAddActorMutation, useAddProjectMutation, useAddRegleMutation } from "../redux/project.api";

interface Props {
    showAddPopup: (show: boolean) => void
}

const AddReglePopup = (props: Props) => {
    const [description, setDescription] = useState("");

    const [createRegle, {isLoading: isAdding}] = useAddRegleMutation();
